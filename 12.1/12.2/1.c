...
void quickSort(siswa[], int, int, int, int);
void urutkan(int, int, int);
int comparator(siswa, siswa, int, int);
...
void merge(siswa arr[], int left, int mid, int right, int berdasarkan, int mode) {
    int i, j, k;
    int n1 = mid - left + 1;
    int n2 = right - mid;
...
void mergeSort(siswa arr[], int left, int right, int berdasarkan, int mode) {
    if (left < right) {
...
int partition(siswa arr[], int low, int high, int berdasarkan, int mode) {
...
void quickSort(siswa arr[], int low, int high, int berdasarkan, int mode) {
    if (low < high) {
...
int comparator(siswa a, siswa b, int berdasarkan, int mode)
{
    int result = 0;
    switch (berdasarkan)
    {   
